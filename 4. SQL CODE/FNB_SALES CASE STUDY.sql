{
   ...
   "metadata": {
    "application/vnd.databricks.v1+cell": {
     ...
     "tableResultSettingsMap": {
      "0": {
       "dataGridStateBlob": "{\"version\":1,\"tableState\":{\"columnPinning\":{\"left\":[\"#row_number#\"],\"right\":[]},\"columnSizing\":{\"Date\":258},\"columnVisibility\":{}},\"settings\":{\"columns\":{}},\"syncTimestamp\":1787398794910}",
       "filterBlob": null,
 ...
 "metadata": {
  "application/vnd.databricks.v1+notebook": {
   ...
   "notebookName": "FNB_SALES CASE STUDY",
   "widgets": {}
  },
  "language_info": {
   "name": "sql"
